  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/components/draft-delete-button.tsx',
        'src/components/entry-link-button.tsx',
        'src/components/entry-link-dialog.tsx',
        'src/components/entry-links-list.tsx',
        'src/components/message-diff-dialog.tsx',
        'src/app/page.tsx',
        'src/components/subscription/SubscriptionStatus.tsx',
        'src/components/subscription/UsageIndicator.tsx',
        'src/components/subscription/SettingsSubscriptionSection.tsx',
      ],
    },
  },
  resolve: {
