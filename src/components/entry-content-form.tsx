...
const EntryTitle = memo(function EntryTitle({ title }: { title: string }) {
  return (
      ...
      <div className="flex-1 pt-5 sm:pt-6 lg:pt-8">
        ...
        <textarea
          ...
          className="flex-1 w-full resize-none bg-transparent text-foreground
            placeholder:text-muted-foreground/50 focus:outline-none focus-visible:ring-2
